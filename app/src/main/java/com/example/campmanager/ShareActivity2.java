...
public class ShareActivity2 extends AppCompatActivity implements View.OnClickListener /*  implementing click listener */ {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            try {
                ...
                //tv.setText("PDF SELECTED....ENTER THE FILE NAME");
    ...
    private void uploadFile() {
        ...
        if (filePath != null) {
            ...
            StorageReference riversRef = storageReference.child("docs/"+pic+".pdf");
    ...
    public void onClick(View view) {
        ...
        //if the clicked button is upload
            ...
            if(et1.getText().toString().equals("")){
                ...
                StorageReference photoRef = storageReference.child("docs/"+et1.getText().toString()+".pdf");
